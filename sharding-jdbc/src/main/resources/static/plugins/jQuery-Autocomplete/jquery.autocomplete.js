    ...
    Autocomplete.prototype = {
        ...
        suggest: function () {
            ...
            $.each(that.suggestions, function (i, suggestion) {
                ...
                html += '<div class="' + className + '" data-index="' + i + '"><span class="suggestion-title">' + formatResult(suggestion, value, i) + '</span><div class="suggestion-title-separator"></div><span class="sub-suggestion-title">' + subTitle  + '</span></div>';
            });
