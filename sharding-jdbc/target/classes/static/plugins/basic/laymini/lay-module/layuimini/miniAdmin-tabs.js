...
layui.define(["jquery", "miniMenu", "element","miniTab", "miniTheme"], function (exports) {
    ...
    var miniAdmin = {
        ...
        render: function (options) {
            ...
            options.homeHref = options.homeHref || null;
            options.logoTitle = options.logoTitle || "";
            options.menuUrl = basePath+"basic/main/layui/init";
            options.clearUrl =  basePath +"api/clear.json";
            $.getJSON(options.menuUrl, function (data) {
                if (data == null) {
    ...
    exports("miniAdminTabs", miniAdmin);
});
