    ...
    var miniTheme = {
        ...
        buildThemeCss: function (bgcolorId) {
            ...
            var styleHtml = '/*头部右侧背景色 headerRightBg */\n' +
                ...
                '}\n' +
                '\n' +
                '/**页面加载动画 layuimini-loader */\n' +
                '.layuimini-loader .layuimini-loader-inner:before, .layuimini-loader .layuimini-loader-inner:after, .layuimini-loader .layuimini-loader-inner {\n' +
                '    border-top-color: ' + bgcolorData.headerRightBg + ';\n' +
                '}\n';
