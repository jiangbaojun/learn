...
/**
 * 修改：
 * 1、messager添加类型标识和alert详细类型（采用icon属性）
 * 2、互换提示框按钮位置，是和否
 * 3、datagrid、treegrid，复选框优化
 * 4、添加datagrid行事件：onMouseEnterRow和onMouseLeaveRow
 * @author：jiangbaojun
 */
(function($){
...
var dlg=_2c5(opts);
dlg.parent("div.messager-window").addClass("vst-messager-alert").addClass(icon);
return dlg;
...
var dlg=_2c5(opts);
dlg.parent("div.messager-window").addClass("vst-messager-confirm");
return dlg;
...
dlg.parent("div.messager-window").addClass("vst-messager-prompt");
return dlg;
...
dlg.parent("div.messager-window").addClass("vst-messager-process");
return dlg;
}};
...
$("<div class=\"datagrid-header-check\"></div>").html("<input type=\"checkbox\" class=\"vst-gridcheck\" id=\"vstCheckAll\"/><label class=\"vst-gridcheck-label not-empty\" for=\"vstCheckAll\"></label>").appendTo(td);
}else{
if(col.field){
td.attr("field",col.field);
...
opts.onMouseLeaveRow.call(opts.finder.getTr(_6c0,_6c1),_6c1); 
}
};
};
function _6c4(e){
...
opts.onMouseEnterRow.call(opts.finder.getTr(_747,_748),_748);  
...
cc.push(" name=\""+_83e+"\" id=\""+_83e+_83b+"\" class=\"vst-gridcheck\" value=\""+(_83f!=undefined?_83f:"")+"\">");
cc.push("<label class=\"vst-gridcheck-label "+($.isEmptyObject(_83c)?"empty":"not-empty")+"\" for=\""+_83e+_83b+"\"></label>");
}else{
if(col.formatter){
...
},onMouseEnterRow:function(_87c){
},onMouseLeaveRow:function(_87c){
...
if(col.checkbox){
if(row.checked){
cc.push("<input type=\"checkbox\" class=\"vst-gridcheck\" checked=\"checked\"");
}else{
cc.push("<input type=\"checkbox\" class=\"vst-gridcheck\"");
}
cc.push(" name=\""+_9b5+"\" id=\""+_9b5+_9b3+"\" value=\""+(row[_9b5]!=undefined?row[_9b5]:"")+"\">");
cc.push("<label class=\"vst-gridcheck-label\" for=\""+_9b5+_9b3+"\"></label>");
}else{
var val=null;
if(col.formatter){
